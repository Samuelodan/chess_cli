...
RSpec.describe Position do
  ...
  describe '#continue_bottom_right' do
    context 'when position is c4' do
      it 'returns all bottom right diagonal positions' do
        pos = Position.new(file: 'c', rank: 4)
        expected_pos = Position.for(['d3', 'e2', 'f1'])
  ...
  describe '#continue_bottom_left' do
    context 'when position is c4' do
      it 'returns all bottom left diagonal positions' do
        pos = Position.new(file: 'c', rank: 4)
        expected_pos = Position.for(['b3', 'a2'])
        new_pos = pos.continue_bottom_left
        expect(new_pos).to eql(expected_pos)
      end
    end
    ...
    context 'when position is f6' do
      it 'returns all bottom left diagonal positions' do
        pos = Position.new(file: 'f', rank: 6)
        expected_pos = Position.for(['e5', 'd4', 'c3', 'b2', 'a1'])
        new_pos = pos.continue_bottom_left
        expect(new_pos).to eql(expected_pos)
      end
    end
  ...
  describe '#continue_top_left' do
    context 'when position is c4' do
      it 'returns all top left diagonal positions' do
        pos = Position.new(file: 'c', rank: 4)
        expected_pos = Position.for(['b5', 'a6'])
        new_pos = pos.continue_top_left
        expect(new_pos).to eql(expected_pos)
      end
    end
    ...
    context 'when position is f6' do
      it 'returns all top left diagonal positions' do
        pos = Position.new(file: 'f', rank: 6)
        expected_pos = Position.for(['e7', 'd8'])
        new_pos = pos.continue_top_left
        expect(new_pos).to eql(expected_pos)
      end
    end
  ...
  describe '#top_right' do
    context 'when position is e5' do
      it 'returns f6 position object' do
        pos = Position.new(file: 'e', rank: 5)
        expected_pos = Position.new(file: 'f', rank: 6)
    ...
    context 'when position is b1' do
      it 'returns c2 position object' do
        pos = Position.new(file: 'b', rank: 1)
        expected_pos = Position.new(file: 'c', rank: 2)
        new_pos = pos.top_right
        expect(new_pos).to eql(expected_pos)
      end
    end
  ...
  describe '#bottom_right' do
    context 'when position is e5' do
      it 'returns f4 position object' do
        pos = Position.new(file: 'e', rank: 5)
        expected_pos = Position.new(file: 'f', rank: 4)
        new_pos = pos.bottom_right
        expect(new_pos).to eql(expected_pos)
      end
    end
  ...
  describe '#bottom_left' do
    context 'when position is e5' do
      it 'returns d4 position object' do
        pos = Position.new(file: 'e', rank: 5)
        expected_pos = Position.new(file: 'd', rank: 4)
  ...
  describe '#top_left' do
    context 'when position is e5' do
      it 'returns d6 position object' do
        pos = Position.new(file: 'e', rank: 5)
        expected_pos = Position.new(file: 'd', rank: 6)
        new_pos = pos.top_left
        expect(new_pos).to eql(expected_pos)
      end
    end

    context 'when position is b3' do
      it 'returns a4 position object' do
        pos = Position.new(file: 'b', rank: 3)
        expected_pos = Position.new(file: 'a', rank: 4)
        new_pos = pos.top_left
        expect(new_pos).to eql(expected_pos)
      end
    end
